function [scLabel,NEWlabel] = SAGL_3views(V1,V2,V3,ind,label,para)
% implements clustering on partial three-view data 
%
% adopted from Jun Guo* and Jiahui Ye*, "Anchors Bring Ease: An Embarrassingly 
